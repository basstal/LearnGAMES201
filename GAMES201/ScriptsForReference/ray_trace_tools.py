...
@ti.data_oriented
class SimpleTorus:
    # reference: https://web.maths.unsw.edu.au/~rsw/Torus/index.php
    #            https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.650.4814&rep=rep1&type=pdf
    # the line-torus intersection seems very difficult ...
    def __init__(self, center, radius, material, color):
